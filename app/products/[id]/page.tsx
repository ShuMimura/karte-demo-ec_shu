            ...
            <div className="bg-white rounded p-6 border border-gray-300">
              ...
              <div className="flex gap-2 mb-3">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 shadow-sm transition"
                  aria-label={favorite ? 'お気に入りから削除' : 'お気に入りに追加'}
                >
                  <svg
                    className={`w-6 h-6 transition ${favorite ? 'fill-red-500 text-red-500' : 'fill-none text-gray-400'}`}
                    stroke="currentColor"
                    strokeWidth={2}
                    viewBox="0 0 24 24"
                  >
